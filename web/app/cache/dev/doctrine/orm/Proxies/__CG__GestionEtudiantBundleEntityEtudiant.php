 ...
 */
class Etudiant extends \GestionEtudiantBundle\Entity\Etudiant implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GestionEtudiantBundle\\Entity\\Etudiant' . "\0" . 'nom', '' . "\0" . 'GestionEtudiantBundle\\Entity\\Etudiant' . "\0" . 'id', '' . "\0" . 'GestionEtudiantBundle\\Entity\\Etudiant' . "\0" . 'notes');
        }
