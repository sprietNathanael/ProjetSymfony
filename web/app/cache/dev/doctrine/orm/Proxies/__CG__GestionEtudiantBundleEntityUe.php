 ...
 */
class Ue extends \GestionEtudiantBundle\Entity\Ue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GestionEtudiantBundle\\Entity\\Ue' . "\0" . 'semestre', '' . "\0" . 'GestionEtudiantBundle\\Entity\\Ue' . "\0" . 'codeApogee', '' . "\0" . 'GestionEtudiantBundle\\Entity\\Ue' . "\0" . 'nomUe', '' . "\0" . 'GestionEtudiantBundle\\Entity\\Ue' . "\0" . 'coefficient', '' . "\0" . 'GestionEtudiantBundle\\Entity\\Ue' . "\0" . 'id', '' . "\0" . 'GestionEtudiantBundle\\Entity\\Ue' . "\0" . 'modules');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Ue $proxy) {
    ...
    public function setCodeApogee($codeApogee)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCodeApogee', array($codeApogee));

        return parent::setCodeApogee($codeApogee);
    }
    ...
    public function getCodeApogee()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCodeApogee', array());

        return parent::getCodeApogee();
    }
    ...
    public function setNomUe($nomUe)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNomUe', array($nomUe));

        return parent::setNomUe($nomUe);
    }
    ...
    public function getNomUe()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNomUe', array());

        return parent::getNomUe();
    }
